<template>
  <div class="flex flex-col gap-3 md:gap-4">
    <div class="flex gap-2 md:gap-4 text-text-dark items-center">
      <span class="text-lg md:text-xl font-normal capitalize whitespace-nowrap">{{
        'Choose Options'
      }}</span>
    ...
    <div class="grid grid-cols-1 border border-border-gray">
      ...
      >
        <span class="text-text-dark text-sm md:text-base font-semibold col-span-1 mb-1 sm:mb-0">{{
          option
        }}</span>
        <span
          class="text-gray-600 sm:text-text-dark text-sm md:text-base font-normal sm:col-span-2"
          >{{
